...
> **Superseded（2026-05-29）**：layout/draw 双轨与 canvas peaks 已废弃；WS 现为唯一可见波形渲染器。现行见 [`desktop-waveform-engine.md`](../architecture/desktop-waveform-engine.md)。归档规格见 [`archive/waveform-pre-ws-only-2026-05/`](../execution/specs/archive/waveform-pre-ws-only-2026-05/README.md)。
...
- [`waveform-single-scroll-consolidation-plan.md`](../execution/specs/archive/waveform-pre-ws-only-2026-05/waveform-single-scroll-consolidation-plan.md)  
