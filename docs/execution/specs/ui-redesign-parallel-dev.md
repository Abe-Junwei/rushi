...
## 受影响代码地图
- `DESIGN.md` — 桌面端视觉意图与设计 token 真源（**Notion Zen**；2026-05 起由 Serene Scholar 演进；Stitch 副本见 `docs/stitch-upload/01-DESIGN.md`）。
- `apps/desktop/stitch-welcome-hub-layout.html` — 欢迎 / Hub Stitch 线框（原 `apps/desktop/docs/stitch-*-spec.md` 已随 upload pack 移除）。
- `apps/desktop/stitch-waveform-polish-layout.html` — 校对工作页波形区 Stitch 线框。
