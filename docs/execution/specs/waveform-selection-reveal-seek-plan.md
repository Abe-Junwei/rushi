...
> **状态**：**S0–S11 已编码**；自动化（typecheck / test / guard）已绿；**手测 H1–H20 Go**（2026-06-20 · [`waveform-selection-reveal-seek-hand-test-checklist.md`](./waveform-selection-reveal-seek-hand-test-checklist.md)）  
...
| **5.3** | 列表 range drag 无 auto-scroll | 属实（**S8 已修复**） | **S8** |
| **5.4** | 过滤隐藏选中无提示 | 属实（**S8 已修复**） | **S8** |
