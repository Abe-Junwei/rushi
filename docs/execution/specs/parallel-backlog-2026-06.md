...
| **R3h-0** | 🟡 | mac 机器闸门 ✅ — [signoff](./r3h-0-phase-signoff-2026-06.md)；Win §4 ⏳ |
...
|----|------|------|------|-------------|----------|
| **R3h-0** | 构建 smoke + Win 磁盘 + pip UI 降级 | 2–3d | 🟡 **mac ✅** | [r3h-0 acceptance](./r3h-0-asr-sidecar-build-smoke-acceptance.md) · [signoff](./r3h-0-phase-signoff-2026-06.md) | Win §4 待测；**勿**在全绿前签收 R3f 安装包 |
