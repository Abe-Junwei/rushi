...
- **时间（UTC）**：2026-06-20T05:26:10Z
- **macOS**：26.5.1
- **隔离 HOME**：`/var/folders/j4/b03_8dm52y5g4txtq946jqjc0000gn/T//rushi-fresh-home.EUeoj6`（测试结束已删除）
...
| 一键准备（none）→ `ready_for_transcribe` | ⏸ skip-download1 |
| UI osascript | n/a |
| log 无 `desktop:dev` 文案 | ✅ |

## 产物

- Artifacts: `/var/folders/j4/b03_8dm52y5g4txtq946jqjc0000gn/T//r3f-fresh-20260620-132604`（临时目录，可手动清理）
