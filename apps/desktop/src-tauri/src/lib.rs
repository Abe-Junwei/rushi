...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            local_runtime::recovery::local_runtime_revalidate_install,
            local_runtime::recovery::local_runtime_clear_install,
            local_runtime::recovery::local_runtime_restore_previous,
