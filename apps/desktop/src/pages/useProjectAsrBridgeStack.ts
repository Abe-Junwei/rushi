...
export function projectAsrControllerFields(
  ...
  return {
    ...
    offlinePackImportBusy: asr.offlinePackImportBusy,
    offlinePackImportProgress: asr.offlinePackImportProgress,
    offlinePackImportFailure: asr.offlinePackImportFailure,
    importOfflineAsrModelsPack: asr.importOfflineAsrModelsPack,
    cancelOfflineAsrModelsPackImport: asr.cancelOfflineAsrModelsPackImport,
    openOfflineAsrModelsPackReleasePage: asr.openOfflineAsrModelsPackReleasePage,
