...
export function projectLifecycleControllerFields(lifecycle: ProjectLifecycleController) {
  return {
    ...
    exportBundleScopeOpen: lifecycle.exportBundleScopeOpen,
    exportBundleScope: lifecycle.exportBundleScope,
    setExportBundleScope: lifecycle.setExportBundleScope,
    closeExportBundleScope: lifecycle.closeExportBundleScope,
    confirmExportBundleScope: lifecycle.confirmExportBundleScope,
    canExportCurrentProjectBundle: lifecycle.canExportCurrentProjectBundle,
    importProjectBundle: lifecycle.importProjectBundle,
    bundleImportConflictPending: lifecycle.bundleImportConflictPending,
    bundleImportConflictDrafts: lifecycle.bundleImportConflictDrafts,
    setBundleImportConflictDraft: lifecycle.setBundleImportConflictDraft,
    applyAllBundleImportOverwrite: lifecycle.applyAllBundleImportOverwrite,
    applyAllBundleImportRename: lifecycle.applyAllBundleImportRename,
    cancelBundleImportConflict: lifecycle.cancelBundleImportConflict,
    confirmBundleImportConflict: lifecycle.confirmBundleImportConflict,
