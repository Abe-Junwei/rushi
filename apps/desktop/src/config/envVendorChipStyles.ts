...
export function envVendorChipClass(active: boolean): string {
  return active
    ? "border-accent-action/40 bg-notion-bg font-semibold text-notion-text"
...
export const ENV_EXTERNAL_LINK_CLASS =
  "text-accent-action underline decoration-accent-action/30 underline-offset-2 hover:text-notion-text";
