...
export const transcriptFrozenLineTheme = EditorView.theme({
  ...
  ".cm-transcript-frozen-line.cm-transcript-frozen-selected": {
    ...
    boxShadow: [
      ...
      "var(--cm-stage-gutter-width, 8.75rem) 0 0 0 color-mix(in srgb, var(--notion-callout-bg) 70%, transparent)",
    ].join(", "),
  },
  ...
  ".cm-transcript-frozen-line.cm-transcript-frozen-in-selection": {
    ...
    boxShadow: [
      ...
      "var(--cm-stage-gutter-width, 8.75rem) 0 0 0 color-mix(in srgb, var(--notion-callout-bg) 40%, transparent)",
    ].join(", "),
  },
  ...
  ".cm-transcript-frozen-line::after": {
    ...
    right: "calc(-1 * var(--cm-stage-gutter-width, 8.75rem))",
    zIndex: "-1",
