...
import type { P1SegmentContextMenuItem } from "../utils/p1SegmentContextMenuModel";

type Props = {
  x: number;
  y: number;
  items: P1SegmentContextMenuItem[];
  onSelect: (key: P1SegmentContextMenuItem["key"]) => void;
  onClose: () => void;
};
...
export function P1SegmentContextMenu({ x, y, items, onSelect, onClose }: Props) {
