...
export const STT_ONLINE_PROVIDER_DEFINITIONS: SttOnlineProviderDefinition[] = [
  {
    ...
    experimental: false,
    market: "china",
    credentialHint: "百炼 sk- 密钥，可与 LLM 百炼共用。",
  ...
  },
  {
    id: "openai",
    label: "OpenAI",
    description: "在线转写默认 whisper-1（词级/句级时间戳）；使用令牌认证。",
    ...
    experimental: false,
    market: "global",
    credentialHint: "OpenAI API 密钥（sk-…）。",
    credentialPlaceholder: "sk-…",
  ...
  },
  {
    id: "assemblyai",
    label: "AssemblyAI",
    description: "异步转写任务 + 轮询/回调；支持流式识别。",
    ...
    experimental: false,
    market: "global",
    credentialHint: "AssemblyAI API 密钥。",
  ...
  },
  {
    id: "deepgram",
    label: "Deepgram",
    description: "Nova 等模型；支持流式与预录文件转写，令牌认证。",
    ...
    experimental: false,
    market: "global",
    credentialHint: "Deepgram API 密钥或访问令牌。",
    credentialPlaceholder: "令牌或 API 密钥",
  ...
  },
  {
    ...
    experimental: true,
    market: "global",
    credentialHint: "自建网关 POST 地址 + 访问令牌。",
    credentialPlaceholder: "代理令牌或 API 密钥",
  },
];
