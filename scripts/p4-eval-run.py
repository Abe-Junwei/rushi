...
用法（仓库根）:
  python3 scripts/p4-eval-run.py
  python3 scripts/p4-eval-run.py --manifest fixtures/p4-eval/eval_manifest.v1.json --asr-base http://127.0.0.1:8741
"""
...
def main() -> int:
    ...
    ap.add_argument(
        "--manifest",
        type=Path,
        default=ROOT / "fixtures" / "p4-eval" / "eval_manifest.v1.json",
